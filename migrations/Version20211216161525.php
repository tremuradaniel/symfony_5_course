 ...
 */
final class Version20211216161525 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, age FROM user');
        ...
        , password VARCHAR(255) NOT NULL, age SMALLINT DEFAULT 10 NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, age) SELECT id, email, roles, password, age FROM __temp__user');
